		...
		// setter
			...
			for (key in hash) {
				...
				if (result !== false) {
					...
					// Api for animation and quick access without polling the DOM
					wrapper[key] = value;
...
Axis.prototype = {
	...
	setAxisTranslation: function (saveOld) {
		...
		if (axis.isXAxis) {
			...
			// Api minPointOffset and pointRangePadding
...
Series.prototype = {
	...
	getGraphPath: function () {
		...
		// Api it for use in drawGraph and drawTracker, and return graphPath
	...
	drawDataLabels: function () {
		...
		while (i--) {
			...
			for (j = 0; j < length; j++) {
				...
				// Api the placement and visibility
				dataLabel._attr = {
					visibility: visibility,
					align: labelPos[6]
				};
